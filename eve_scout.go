...
// --- EVE-Scout Client Definitions ---

// EveScoutClient manages communication with the EVE-Scout API.
...
// TheraConnection defines the structure for a wormhole signature from EVE-Scout.
type TheraConnection struct {
	ID                string    `json:"id"`
	DestinationSystem *System   `json:"destination_solar_system"`
	ExpiresAt         time.Time `json:"expires_at"`
}

// System defines the structure for the destination system.
type System struct {
	ID   int    `json:"id"`
